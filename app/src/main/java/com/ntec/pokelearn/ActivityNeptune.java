...
public class ActivityNeptune extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageBack2Main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ActivityNeptune.super.onBackPressed();
            }
        });
    }

    private Fact[] mFact = new Fact[]{
            new Fact(R.string.neptuneFact1),
            new Fact(R.string.neptuneFact2),
            new Fact(R.string.neptuneFact3),
            new Fact(R.string.neptuneFact4),
            new Fact(R.string.neptuneFact5),
            new Fact(R.string.neptuneFact6),
            new Fact(R.string.neptuneFact7),
            new Fact(R.string.neptuneFact8),
            new Fact(R.string.neptuneFact9),
            new Fact(R.string.neptuneFact10),
            new Fact(R.string.neptuneFact11),
            new Fact(R.string.neptuneFact12),
            new Fact(R.string.neptuneFact13),
            new Fact(R.string.neptuneFact14),
            new Fact(R.string.neptuneFact15),
    };
